...
--
CREATE TABLE "usuario" ("id" serial NOT NULL PRIMARY KEY, "password" varchar(128) NOT NULL, "last_login" timestamp with time zone NULL, "is_superuser" boolean NOT NULL, "criado" timestamp with time zone NULL, "modificado" timestamp with time zone NULL, "matricula" varchar(7) NOT NULL UNIQUE, "first_name" varchar(30) NULL, "last_name" varchar(30) NULL, "email" varchar(254) NULL, "is_active" boolean NOT NULL);
